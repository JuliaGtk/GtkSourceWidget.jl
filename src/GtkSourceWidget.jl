...
get_search_path(manager::GtkSourceLanguageManager) = ccall(
    (:gtk_source_language_manager_get_search_path, libgtksourceview), Ptr{Ptr{UInt8}},
    (Ptr{GObject}, ), manager
)
...
"""
set_search_path(manager::GtkSourceLanguageManager, dir)  = ccall(
    (:gtk_source_language_manager_set_search_path, libgtksourceview), Nothing,
...
GtkSourceSearchContextLeaf(buffer::GtkSourceBuffer, settings::GtkSourceSearchSettings) = 
    GtkSourceSearchContextLeaf(
        ccall((:gtk_source_search_context_new, libgtksourceview), Ptr{GObject}, (Ptr{GObject}, Ptr{GObject}),
        buffer, settings)
    )
...
function search_context_replace(
    ...
    out = ccall((:gtk_source_search_context_replace, libgtksourceview), Cint,
        (Ptr{GObject}, Ref{GtkTextIter}, Ref{GtkTextIter}, Ptr{UInt8}, Cint, Ptr{Nothing}),
...
search_context_replace(
    search::GtkSourceSearchContext,
    match_start::GtkTextIter, match_end::GtkTextIter,
    replace::String) = search_context_replace(search, mutable(match_start), mutable(match_end), replace)
...
style_scheme_chooser() = Gtk.GtkWidgetLeaf(
    ccall((:gtk_source_style_scheme_chooser_widget_new, libgtksourceview), Ptr{GObject}, ())
)
style_scheme_chooser_button() = Gtk.GtkWidgetLeaf(
